    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={styles.headerBox}>
           <Typography variant="h3" weight="800">Select Type</Typography>
           <Typography variant="body2" color={Colors.light.textSecondary}>Choose a subcategory in {categoryName}</Typography>
        </View>
        ...
        <View style={styles.list}>
          {subcategories.map((sub, index) => (
            <Pressable 
              ...
              onPress={() => navigation.navigate('GroceryProductList', { 
                categoryId, 
                subcategoryName: sub,
                categoryName 
              })}
